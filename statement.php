                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                ?>
                                                                                <img src="./img/b_ball.png" width="27px;">&nbsp; 
                                                                                <?php
                                                                                }
                                                                                else if ($match['gameType'] == 4) {
                                                                                ?>
                                                                                <img src="./img/boxing.png" width="27px;">&nbsp; 
                                                                                <?php
                                                                                }
                                                                                else if ($match['gameType'] == 5) {
                                                                                ?>
                                                                                <img src="./img/tenis.png" width="27px;">&nbsp; 
                                                                                <?php
                                                                                }
                                                                                else if ($match['gameType'] == 6) {
                                                                                ?>
                                                                                <img src="./img/tabletennis.png" width="27px;">&nbsp; 
                                                                                <?php
                                                                                }
                                                                                else if ($match['gameType'] == 7) {
                                                                                ?>
                                                                                <img src="./img/badminton.png" width="27px;">&nbsp; 
                                                                                <?php
                                                                                }
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <button style="" class="btn btn-default btn-sm "><span><img src="img/win.png"></span>
                                                                                </button>
                                                                                ...
                                                                                <button style="" class="btn btn-default btn-sm "><span><img src="img/lose.png"></span>
                                                                                </button>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu">
                                                                                <li><a href="withdrawCancel.php?wCancel=<?php echo $DepositAndWithdraw['id']; ?>" >Request Canceled </a></li>
...
<footer class="footer-basic-centered">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
    <a  class="" href=""><img style="width: 110px;height: 40px;margin-left: 10px;border-radius:5px;" src="img/logo.png"></a>
                <p style="font-size: 15px;color: #dcdcdc;" class="footer-company-name">Demoforyou.xyz &copy; <?php echo date("Y"); ?> all right reserved.</p>
            </div>
