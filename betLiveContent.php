                        ...
                        <h4 class="panel-title">
                            ...
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $bettingTitle['id'] ?>one" aria-expanded="true" aria-controls="collapseOne<?php echo $bettingTitle['id'] ?>one">
                                ...
                                if ($bettingTitle['gameType'] == 1) {
                                    ?>
                                <img src="../img/1393757333.png" width="25px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 

                                    <button class="btn btn-primary  btn-sm matchActionMenu" data-toggle="modal" id="<?php echo $bettingTitle['id'] ?>" data-target="#matchActionMenu">action </button>
                                   <button class="btn btn-info  btn-sm matchActiondefault" data-toggle="modal" id="<?php echo $bettingTitle['id'] ?>" data-target="#default">d-hidden</button>
 <button class="btn btn-primary  btn-sm scoreM" id="<?php echo $bettingTitle['id'] ?>" data-toggle="modal" data-target="#scoreModal">Score(<?php echo $bettingTitle['liveScore'] ?>) </button>
                                    <button class="btn btn-primary  btn-sm limitMatch" id="<?php echo $bettingTitle['id'] ?>" data-toggle="modal" data-target="#limitMatch">Limit(<?php echo $bettingTitle['limitedAmount'] ?>) </button>
                                    <button class="btn btn-primary  btn-sm matchWatting" data-toggle="modal" id="<?php echo $bettingTitle['id'] ?>" data-target="#matchWatting">Wait(<?php echo $bettingTitle['waittingTime'] ?>) </button>
                                    ...
                                    ?>
                                    <img src="../img/ka-pl.png" width="25px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                    ...
                                    ?>
                                    <img src="../img/ka-pl.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                    ...
                                    ?>
                                    <img src="../img/boxing.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                    ...
                                    ?>
                                    <img src="../img/tenis.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                    ...
                                    ?>
                                    <img src="../img/tabletennis.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                    ...
                                    ?>
                                    <img src="../img/badminton.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> 
                                                ...
                                                <div class="panel-heading" role="tab" id="headingOne<?php echo $bettingTitle['id'] ?>one<?php echo $bettingSubTitle['id'] ?>">
                                                    <h4 class="panel-title">
                                                        <a  style="background:#E7E7E7 !important;color: #212529;padding: 1%;border-bottom: 1px solid #979797;" role="button" data-toggle="collapse" data-parent="#accordion<?php echo $bettingTitle['id'] ?>one" href="#collapseOne<?php echo $bettingTitle['id'] ?>one<?php echo $bettingSubTitle['id'] ?>" aria-expanded="true" aria-controls="collapseOne<?php echo $bettingTitle['id'] ?>one<?php echo $bettingSubTitle['id'] ?>">
                                                            ...
                                                            <?php
                                                            $query = "SELECT * FROM `bet` where betTitleId='$bettingSubTitle[id]'";
                                                            $Count = $db->select($query);
                                                            ...
                                                            include'db.php';
                                                            $id=$bettingTitle['id'];
                                                            $q="select * from bet where matchId='$id' and betStatus='1' and betTitleId='$bettingSubTitle[id]'";
                                                             $run=mysqli_query($con,$q);
                                                             while($row=mysqli_fetch_array($run))
                                                             {

                                                                 echo @$row['betstatusby'];
                                                             }
