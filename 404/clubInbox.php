                                            ...
                                            if ($deposit['wAction'] == 0) {
                                                ...
                                                <div  class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="depositWithdrawAction?userId=<?php echo $deposit['userId']; ?> && wAction=1&& ref_number=<?php echo $deposit['id']; ?>" >Processing</a>
                                                        ...
                                                        <a class="dropdown-item" href="depositWithdrawAction?Wcancel=<?php echo $deposit['id']; ?>" >Cancel</a>
                                                    </div>
                                                </div>
