    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if (isset($_POST['serchByDate'])) {
                ...
                $ans = $_GET['ans'];
                $query = "select * from bet where betId='$_GET[ans]' order by time asc";
                $resultUser = $db->select($query);
            }
            ?>
            <form class="row" action="searchEngine.php?ans=<?php echo $_GET['ans']; ?>" method="post">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select name="from" class="form-control selectpicker" id="select-country" data-live-search="true">
                        ...
                        <?php
                        $query = "select * from bet where betId='$_GET[ans]' order by time desc";
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="refungAmount" class="form-control"  id="refund_amount" rows="3" autofocus>
                                </div>
                                <div class="form-group">
                                    <div class="radio">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" name="refund" id="refund_submit" class="btn btn-primary">Submit</button>
                                </div>
                            </div>
                            <div class="modal-footer">
                                        ...
                                        while ($user = $resultUser->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>  
                                                    ...
                                                    <div class="animated-checkbox">
                                                        <label>
                                                            <input type="checkbox" class="cb-element checkbox" id="<?php echo $user['id'] ?>" value="<?php echo $user['id'] ?>" onclick="chk(<?php echo $user['id'] ?>)"><span class="label-text"></span>
                                                        </label>
                                                    </div>
