                                        ...
                                        while ($user = $resultUser->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>    <?php echo $user['mobileNumber'] ?> </td>
                                                 <!--<td><a href="../index.php?uvisit=<?php echo $user['userId']; ?>" target="_blank" class="btn btn-primary">visit</a> </td>-->
                                                <td>  
                                                                ...
                                                                <form method="post" action="" class="form-group">
                                                                    <table class="table table-bordered">
                                                                        ...
                                                                        <tr>
                                                                            <th>password</th>
                                                                            <td>
                                                                                <input class="form-control" name="password" type="text" value="<?php echo md5($user['password']) ?>" >
                                                                            </td>
