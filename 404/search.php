      ...
      <div class="page-header col-md-12">
			...
			<div class="table-responsive">
				<table class="table table-dark">
					<tr>
						<th>Total Deposit by Date</th>
						<th>Total Amount</th>
					</tr>
				<?php
					include ('db.php');
					$query = "SELECT sum(deposit) as total FROM admin_notification where notificationType=1 and action=1 and seen=1 and (STR_TO_DATE(time,'%d %b %Y %h:%i %p') BETWEEN '".$_POST['date_from']." 00:00:01' and '".$_POST['date_from']." 23:59:59')";
