                    ...
                    <div class="col-lg-8" style="margin-bottom: 15px;">
                        <form method="post" action="">
                         ...
                         <div class="control-group">
                                <label class="control-label">From User Id (যে একাউন্ট থেকে টাকা পাঠাবেন)</label>
                                 <select name="fromUser" class="form-control selectpicker" id="select-country" data-live-search="true">
                                    ...
                                    if ($resultTime) {
                                        foreach ($resultTime as $time) {
                                            ?>
                                            <option><?php echo $time['userId']; ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="control-group">
                                <label class="control-label">To User Id (যে ইউজারকে টাকা পাঠাবেন)</label>
