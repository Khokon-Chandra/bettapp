    ...
    <div class="row">
        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="">
                                                    <label>
                                                        ...
                                                        <input class="gameTypec" type="radio" name="gameType" id="gameType" value="2"><span class="label-text">
                                                            Cricket</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="list-group">
                                                ...
                                                <a class="list-group-item btn btn-sm" onclick="return confirm('Are you sure?')" href="defaultPanelAction?deleteMatch=<?php echo $bettingTitle['id'] ?>">Delete
                                                    match</a>
                                                <a class="list-group-item btn btn-sm" onclick="return confirm('Are you sure?')" href="defaultPanelAction?closeMatch=<?php echo $bettingTitle['id'] ?>">Close
                                                    The Match</a>
                                            </div>
                            ...
                            <div id="add-sub-betting-id<?php echo $bettingTitle['id'] ?>" class="modal" style="">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h6>match : <?php echo $bettingTitle['A_team'] ?> <>
                                                    <?php echo $bettingTitle['B_team'] ?> <?php echo $bettingTitle['title'] ?>
                                            </h6>
                                            <form class="form-horizontal" method="post">
                                                    ...
                                                    <select class="form-control col-md-6" id="dTo" name="category">
                                                        ...
                                                        if ($resultreceivingMoneyNumber) {
                                                            while ($receivingMoneyNumber = $resultreceivingMoneyNumber->fetch_assoc()) {
                                                                ...
                                                                $i++;
                                                        ?>
                                                                <option value=" <?php echo $receivingMoneyNumber['id']; ?>">
                                                                    <?php echo $receivingMoneyNumber['title']; ?></option>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingOne<?php echo $bettingTitle['id'] ?>one">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $bettingTitle['id'] ?>one" aria-expanded="true" aria-controls="collapseOne<?php echo $bettingTitle['id'] ?>one">
                                                ...
                                                ?>
                                                    <img src="../img/1393757333.png" width="25px;">&nbsp;
                                                    <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?>
                                                        ,<?php echo $bettingTitle['title'] ?> || <?php echo $bettingTitle['date'] ?>


                                                        <button class="btn btn-primary  btn-sm" href="" data-toggle="modal" data-target="#action-sub-betting-id<?php echo $bettingTitle['id'] ?>">action
                                                        </button>
                                                    ...
                                                    ?>
                                                        <img src="../img/ka-pl.png" width="25px;">&nbsp;
                                                        <?php echo $bettingTitle['A_team'] ?> <>
                                                            <?php echo $bettingTitle['B_team'] ?>
                                                            ,<?php echo $bettingTitle['title'] ?> ||
                                                            <?php echo $bettingTitle['date'] ?>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="list-group">
                                                                                ...
                                                                                <a class="list-group-item btn btn-sm" onclick="return confirm('Are you sure?')" href="defaultPanelAction?deleteQuestion=<?php echo $bettingSubTitle['id'] ?>">Delete</a>
                                                                ...
                                                                <div class="panel-heading" role="tab" id="headingOne<?php echo $bettingTitle['id'] ?>one<?php echo $bettingSubTitle['id'] ?>">
                                                                    <h4 class="panel-title">
                                                                        <a style="background:#E7E7E7 !important;color: #212529;padding: 1%;border-bottom: 1px solid #979797;" role="button" data-toggle="collapse" data-parent="#accordion<?php echo $bettingTitle['id'] ?>one" href="#collapseOne<?php echo $bettingTitle['id'] ?>one<?php echo $bettingSubTitle['id'] ?>" aria-expanded="true" aria-controls="collapseOne<?php echo $bettingTitle['id'] ?>one<?php echo $bettingSubTitle['id'] ?>">
                                                                            ...
                                                                            <button style="" class="btn btn-primary  btn-sm" href="" data-toggle="modal" data-target="#action-sub-betting-option-id<?php echo $bettingSubTitle['id'] ?>">Action
                                                                            </button>
                                                                                        ...
                                                                                        <div class="table-responsive">
                                                                                            <table class="table table-bordered ">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    ...
                                                                                                    ?>
                                                                                                            <tr>
                                                                                                                <th> <?php echo $BettingSubTitleOption['title'] ?>
                                                                                                                </th>
                                                                                                                <td> <a href="" class="btn btn-primary" data-toggle="modal" data-target="#edit-betting-rate<?php echo $BettingSubTitleOption['id'] ?>">
                                                                                                                        <?php echo $BettingSubTitleOption['amount'] ?></a>
                                                                                                                </td>
                                                                                        ...
                                                                                        <div id="edit-betting-rate<?php echo $BettingSubTitleOption['id'] ?>" class="modal editRate" style="">
                                                                                            <div class="modal-dialog modal-sm" role="document">
                                                                                                <div class="modal-content">
                                                                                                    ...
                                                                                                    <div class="modal-body">
                                                                                                        <h6> <?php echo $bettingSubTitle['title'] ?>
                                                                                                        </h6>
            ...
            <div class="alert alert-dismissible alert-danger">
                <button class="close" type="button" data-dismiss="alert">×</button><strong>Match not Found
                    !!!</strong>
            </div>
        <?php
                    }
...
<script>
    $(document).ready(function() {
        ...
        var new_field_html_sub =
            '<div class="form-group row"> <div class="col-md-6"><input class="form-control" name="input_field[]"  placeholder="Enter Bet Statement"> <a href="javascript:void(0);" class="remove_input_button-sub" title="Remove field"> <i style="background: red;color: white;padding: 9px;border-radius: 43%;margin-top: 6px;" class="fa fa-minus" ></i></a></div></div>';
