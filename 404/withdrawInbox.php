                                ...
                                if ($result) {
                                    ...
                                    foreach ($result as $deposit) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../index.php?uvisit=<?php echo $deposit['userId']; ?>" target="_blank" class="btn btn-primary">visit</a> </td>
                                            ...
                                            if ($deposit['wAction'] == 0) {
                                                ...
                                                <div  class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <input type="hidden" name="from_number" value="<?php echo $deposit['from_number']; ?>">
                ...
                <div class="tile-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered" id="sampleTable2">
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM `admin_notification` WHERE seen='1' and wAction<3 and notificationType=2 and userType=0 order by id desc limit 1000";
                                $result = $db->select($query);
