...
//deposit
    ...
    $rate = $_GET['rate'];
    $amount = $amount * $rate;
    $q="select * from admin_notification where id='$id'";
    ...
    if ($userId != '') {
        ...
        $query = "update `admin_notification` set seen='1',actionAt='$dt',userBalance='$amount' WHERE userId='$userId' and ref_number='$ref_number' and seen=0 order by id desc limit 1";
...
//process
    ...
    if ($id != '') {
        ...
        $query = "select * from `admin_notification`  WHERE id='$id' and wAction='1'";
