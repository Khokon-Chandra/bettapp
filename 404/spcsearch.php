...
<div class="app-content">
    <div class="container">
      ...
      <div class="page-header col-md-12">
			<form method="post" action="spcsearch.php"  class="form-inline">
			...
			<div class="table-responsive">
				<table class="table table-dark">
					<tr>
						<th>Total SponsorCommission by Date</th>
						<th>Total Amount</th>
					</tr>
				<?php
					include ('db.php');
					$query = "SELECT sum(sposor) as total FROM `transaction` where (STR_TO_DATE(time,'%d %b %Y %h:%i %p') BETWEEN '".$_POST['date_from']." 00:00:01' and '".$_POST['date_from']." 23:59:59')";
