...
<?php
$query = "SELECT * FROM `betting_title` where status=2 and close=0 ORDER BY STR_TO_DATE(date,'%d %b %Y %h:%i %p') asc";
                        ...
                        <h4 class="panel-title">
                            <a class="upcoming_panel" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $bettingTitle['id'] ?>one" aria-expanded="true" aria-controls="collapseOne<?php echo $bettingTitle['id'] ?>one">
                                ...
                                if ($bettingTitle['gameType'] == 1) {
                                    ...
                                    ?>
                                    <img src="../img/b_ball.png" width="30px;">&nbsp; <?php echo $bettingTitle['A_team'] ?> <> <?php echo $bettingTitle['B_team'] ?> ,<?php echo $bettingTitle['title'] ?> || <?php echo substr_replace($bettingTitle['date'], "@", 12, 0) ?> || End Time <span style="color: yellow;">- [<?php echo $bettingTitle['dateend'] ?>]</span> 
                        ...
                        <div id="collapseOne<?php echo $bettingTitle['id'] ?>one" class="panel-collapse " role="tabpanel" aria-labelledby="headingOne<?php echo $bettingTitle['id'] ?>one">
                            <div class="panel-body" style="">
                                ...
                                <div class="panel-group" id="accordion<?php echo $bettingTitle['id'] ?>one" role="tablist" aria-multiselectable="true">
                                    <?php
                                    $query = "SELECT * FROM `betting_subtitle` WHERE bettingId='$bettingTitle[id]' and close=0 and section_hide=1 order by id asc";
                                                                                    ...
                                                                                    if ($resultBettingSubTitleOption) {
                                                                                        while ($BettingSubTitleOption = $resultBettingSubTitleOption->fetch_assoc()) {
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td> <a href="" class="btn btn-primary updateAnsRate" tt="<?php echo $BettingSubTitleOption['title'] ?>" data-toggle="modal" id="<?php echo $BettingSubTitleOption['id'] ?>" data-target="#updateAnsRate" onclick="loadrateup('<?php echo $BettingSubTitleOption['amount'] ?>')"> <?php echo $BettingSubTitleOption['amount'] ?></a> </td>
