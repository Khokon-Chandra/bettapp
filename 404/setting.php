...
if (isset($_POST['addMember'])) {
    ...
    if ($result) {
        ...
        echo$query = "INSERT INTO admin(`name`,`userName`, `password`,`type`,email)VALUES ('$name','$userId','$password','2','0')";
...
if (isset($_POST['addMemberThird'])) {
    ...
    if ($result) {
        ...
        $query = "INSERT INTO `admin`(`name`,`userName`, `password`,`type`,email)VALUES('$name','$userId','$password','3','0')";
        $resultClubInsert = $db->insert($query);
...
if (isset($_POST['updateMinimum'])) {
    ...
    if ($balance > 1) {
                    ...
                    <div  class="alert alert-danger errorWithraw" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
                            ×</button>  <strong>  Opps !!</strong> Invalid Club Commission.
                    </div>
                    <?php
                } else {
    $query = "UPDATE `rule` SET"
                            ...
                            <div class="list-group">
                                ...
                                if ($resultsendingMoneyNumber) {
                                    while ($sendingMoneyNumber = $resultsendingMoneyNumber->fetch_assoc()) {
                                        ...
                                        <li class="list-group-item list-group-item-action" ><?php echo $sendingMoneyNumber['userName']; ?><a href="delete_admin2?del=<?php echo $sendingMoneyNumber['userName']; ?>" class="btn btn-sm btn-danger pull-right" style="float: right;">Delete</a><a href=""  data-toggle="modal" data-target="#update-2nd" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">Update</a>
                            ...
                            <div class="list-group">
                                ...
                                if ($resultsendingMoneyNumber) {
                                    while ($sendingMoneyNumber = $resultsendingMoneyNumber->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $sendingMoneyNumber['userName']; ?><a href="delete_admin3?del=<?php echo $sendingMoneyNumber['userName']; ?>" class="btn btn-sm btn-danger pull-right" style="float: right;">Delete</a><a href="" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">Update</a></li>
