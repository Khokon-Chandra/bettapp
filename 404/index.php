...
<main class="app-content">
    <div class="row">
        ...
        <!-- ==== NEW Menu Start========= -->
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-btc "></i>
                <div class="info">
                    <h6>Total Bet No Result</h6>
                    <p>
                       Demo
                    </p>
                </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-krw "></i>
                <div class="info">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-krw fa-3x"></i>
                <div class="info">
                    <h6>Total Club Withdraw</h6>
                    <p>
                        <?php
                        $query = "select sum(withdraw) as total from admin_notification where seen=1 and action=1 and userType=2";
                        $UserTotalBalance = $db->select($query);
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-ils "></i>
                <div class="info">
                    <h6>Total Admin Balance</h6>
                    <p>
                       Demo
                    </p>
                </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-usd "></i>
                <div class="info">
                    <h6>S Amount</h6>
                    <p>
                       Demo
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-external-link "></i>
                <div class="info">
                    <h6>Total From Cashout</h6>
                    <p>
                       Demo
                    </p>
                </div>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-money "></i>
                <div class="info">
                    <h6>Todays deposit and Withdraw</h6>
                    <p>
                       Demo
                    </p>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="list-group">
                                ...
                                if ($resultsendingMoneyNumber) {
                                    while ($sendingMoneyNumber = $resultsendingMoneyNumber->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $sendingMoneyNumber['phone']; ?><a href="indexAction?sendingNumberDelete=<?php echo $sendingMoneyNumber['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                            ...
                            <div class="list-group">
                                ...
                                if ($resultreceivingMoneyNumber) {
                                    while ($receivingMoneyNumber = $resultreceivingMoneyNumber->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $receivingMoneyNumber['phone']; ?><a href="indexAction?recvNumberDelete=<?php echo $receivingMoneyNumber['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                            ...
                            <div class="list-group">
                                ...
                                if ($resultMethod) {
                                    while ($method = $resultMethod->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $method['method']; ?> <span  class="badge badge-primary"><?php echo $method['rate']; ?> </span><a href="indexAction?methodNumberDelete=<?php echo $method['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                    ...
                    <div class="col-lg-4" style="margin-bottom: 15px;">
                            ...
                            <div class="list-group">
                                ...
                                if ($resultMethod) {
                                    while ($method = $resultMethod->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $method['method']; ?> <span  class="badge badge-primary"><?php echo $method['rate']; ?> </span><a href="indexAction?w_methodNumberDelete=<?php echo $method['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                        ...
                        <div class="bs-component">
                            ...
                            <div class="list-group">
                                <li class="list-group-item list-group-item-action" >
                                    <form action="cwithdrawactive.php" class="form-group" method="post">
                                        <?php
                                        include "db.php";
                                            ...
                                            if ($result) {
                                                if ($row = mysqli_fetch_array($result)) {
                                                    if ($row["activ"] == 1) {
                                                    echo "<a href='cwithdrawactive?cact=1' class='btn btn-danger btn-block'>De-Active Club Withdraw</a>";    
                                        }
                                        else{
                                                echo "<a href='cwithdrawactive?cdact=0' class='btn btn-info btn-block'>Active Club Withdraw</a>";
                                                }
                                        }
                                                }
