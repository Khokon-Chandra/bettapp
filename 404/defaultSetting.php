                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="list-group">
                                                ...
                                                <a class="list-group-item btn btn-sm" onclick="return confirm('Are you sure?')" href="defaultPanelAction?deleteMatch=<?php echo $bettingTitle['id'] ?>">Delete match</a>
                                                <a class="list-group-item btn btn-sm" onclick="return confirm('Are you sure?')" href="defaultPanelAction?closeMatch=<?php echo $bettingTitle['id'] ?>">Close The Match</a>
                                            </div>
