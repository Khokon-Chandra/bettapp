                                        ...
                                        while ($user = $resultUser->fetch_assoc()) {
                                            ...
                                            <tr>
												...
												<td style="border: 0px !important;"> 
                                                                    ...
                                                                    <form action="" method="post">
                                                                        <input type="hidden" value="<?php echo $user['id'] ?>" name="id">
                                                                        <input type="text" size="10" name="balance" class="text-primary" value="0">
                                                                        <input type="submit" size="10" name="ubal" class="btn btn-danger btn-sm" value="Update">
                                                                    </form>
                                                            </td>
                                            </tr>
                                            <?php
