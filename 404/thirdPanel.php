...
<main class="app-content">
    <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-dollar fa-3x"></i>
                <div class="info">
                    ...
                    <p>
                        <?php
                        $query = "select sum(deposit) as total from admin_notification where seen=1 and action=1";
                        $UserTotalBalance = $db->select($query);
	    ...
	    <div class="col-md-6 col-lg-4">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-dollar fa-3x"></i>
                <div class="info">
                    ...
                    <p>
                        <?php
                        $query = "select sum(withdraw) as total from admin_notification where seen=1 and action=1";
                        $UserTotalBalance = $db->select($query);
		...
		<div class="col-md-6 col-lg-4">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-dollar fa-3x"></i>
                <div class="info">
                    <h6>Total deposit per day</h6>
                    <p>
                        <?php
                        $query = "SELECT SUM(deposit) as total FROM admin_notification WHERE seen=1 and action=1 and STR_TO_DATE(time,'d M Y g:i A') > DATE_SUB(CURDATE(), INTERVAL 1 DAY)";
                        $UserTotalBalance = $db->select($query);
		...
		<div class="col-md-6 col-lg-4">
            <div class="widget-small info coloured-icon"><i class="icon fa fa-dollar fa-3x"></i>
                <div class="info">
                    <h6>Total Withdraw Last Month</h6>
                    <p>
                        <?php
                            ...
                            <div class="list-group">
                                ...
                                if ($resultsendingMoneyNumber) {
                                    while ($sendingMoneyNumber = $resultsendingMoneyNumber->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $sendingMoneyNumber['phone']; ?><a href="taction?sendingNumberDelete=<?php echo $sendingMoneyNumber['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                            ...
                            <div class="list-group">
                                ...
                                if ($resultreceivingMoneyNumber) {
                                    while ($receivingMoneyNumber = $resultreceivingMoneyNumber->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $receivingMoneyNumber['phone']; ?><a href="taction?recvNumberDelete=<?php echo $receivingMoneyNumber['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                            ...
                            <div class="list-group">
                                ...
                                if ($resultMethod) {
                                    while ($method = $resultMethod->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $method['method']; ?> <span  class="badge badge-primary"><?php echo $method['rate']; ?> </span><a href="taction?methodNumberDelete=<?php echo $method['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
                            ...
                            <div class="list-group">
                                ...
                                if ($resultMethod) {
                                    while ($method = $resultMethod->fetch_assoc()) {
                                        ...
                                        $i++;
                                        ?>
                                        <li class="list-group-item list-group-item-action" ><?php echo $method['method']; ?> <span  class="badge badge-primary"><?php echo $method['rate']; ?> </span><a href="taction?w_methodNumberDelete=<?php echo $method['id']; ?>" onclick="return confirm('are you sure ?')"class=" btn btn-sm btn-info pull-right">delete</a></li>
