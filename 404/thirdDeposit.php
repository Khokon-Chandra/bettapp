                                ...
                                if ($result) {
                                    ...
                                    foreach ($result as $deposit) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="amount" id="<?php echo $deposit['id'];  ?>" value="<?php echo $deposit['deposit']; ?>" onchange="valuechange('<?php echo $deposit['id'];  ?>')"></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="depositWithdrawAction?userId=<?php echo $deposit['userId']; ?>&amount=<?php echo $deposit['deposit']; ?>&action=2&to=<?php echo $deposit['to_number']; ?>&ref_number=<?php echo $deposit['ref_number']; ?>&rate=<?php echo $deposit['rate']; ?>&seen=1" >Processed</a>
													<br>
													
                                                 <a class="dropdown-item" href="depositWithdrawAction?Dcancel=<?php echo $deposit['id']; ?>" >Cancel</a>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="depositWithdrawAction?userId=<?php echo $deposit['userId']; ?>&& amount=<?php echo $deposit['deposit']; ?>&action=2&to=<?php echo $deposit['to_number']; ?>&ref_number=<?php echo $deposit['ref_number']; ?>&rate=<?php echo $deposit['rate']; ?>&seen=1 &nid=<?php echo $deposit['id']; ?>" >Processed</a>
