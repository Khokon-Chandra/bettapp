...
if (isset($_POST['match_id'])) {
    ...
    if ($A_team != '' && $B_team != '' && $title != '' && $date != '' && $status != '' && $gameType != '') {
        ...
        $query = "INSERT INTO betting_title(A_team,B_team,title,date,status,gameType,user,color_a,color_b,dates,adminId)VALUES ('$A_team','$B_team','$title','$date','$status','$gameType','$operator','$color_a','$color_b','$dates','$adminId')";
    ...
    if ($status != '' && $gameType != '') {
            ...
            $query = "INSERT INTO betting_title(`A_team`, `B_team`, `title`, `date`, `status`, `gameType`,user,dates,adminId)
            VALUES ('$A_team','$B_team','$title','$date','$status','$gameType','$operator','$dates','$adminId')";
            $resultClubInsert = $db->insert($query);
            // select match id
